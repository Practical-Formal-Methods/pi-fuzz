...
from mod_gym.gym.error import (AlreadyPendingCallError, NoAsyncCallError,
                               ClosedEnvironmentError, CustomSpaceError)
from mod_gym.gym.vector.utils import (create_shared_memory, create_empty_array,
        ...
        if self.shared_memory:
            try:
                ...
                raise ValueError('Using `shared_memory=True` in `AsyncVectorEnv` '
                    ...
                    '(i.e. custom spaces inheriting from `mod_gym.Space`), and is '
