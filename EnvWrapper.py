...
class Wrapper():
    ...
    def create_linetrack_environment(self):
        # environment parameters
        num_lines = 2
        length_lines = 100
        ratios = [0.02, 0.1]
        env = Linetrack(num_lines=num_lines, length_lines=length_lines, mode='line_ratio', ratios=ratios, input_stripe=True, random_seed=123123123)
        self.env = env
        print('Environment created.')

    # @profile
    def run_pol_fuzz(self, init_state, lahead_seq=None):  # policy fuzzer
